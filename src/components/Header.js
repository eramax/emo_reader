    ...
    <div className="self-stretch rounded-[8px] bg-white shadow-[0px_10px_15px_-3px_rgba(0,_0,_0,_0.1),_0px_4px_6px_-2px_rgba(0,_0,_0,_0.05)] h-[54px] shrink-0 overflow-hidden flex flex-row p-[8px_16px_8px_22px] box-border items-center justify-start gap-[16px] text-left text-lg text-gray-500 font-inter">
      ...
      <div className="flex flex-row items-center justify-center gap-[16px]">
        <div className="flex flex-row items-start justify-start">
          <button className="cursor-pointer [border:1px_solid_#f3f4f6] p-[8px_12px] bg-gray-100 rounded-[4px_0px_0px_4px] box-border relative h-[38px] flex flex-row items-center justify-center hover:bg-gray-200">
            <img
          ...
          <button className="cursor-pointer [border:1px_solid_#f3f4f6] p-[8px_12px] bg-gray-100 rounded-[0px_4px_4px_0px] box-border relative h-[38px] flex flex-row items-center justify-center hover:bg-gray-200">
            <img
              className="relative w-[24px] h-[24px] shrink-0 overflow-hidden"
              alt=""
